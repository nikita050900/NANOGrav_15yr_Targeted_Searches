...
savefile = '/scratch/na00078/QuickCW_targeted_runs/results/NGC3115.h5'
#savefile = None

###############
#targeted search params-LondonAdd
c = SkyCoord(ra = '10h05m13.978s', dec = '-07d43m06.89s')
...
chain_params = ChainParams(T_max,n_chain, n_block_status_update,
                           freq_bounds=np.array([np.nan, 1e-6]), #prior bounds used on the GW frequency (a lower bound of np.nan is interpreted as 1/T_obs)
